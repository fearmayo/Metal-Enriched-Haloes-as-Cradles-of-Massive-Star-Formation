...
Recall that the \rarepeak environment is a bias region and so the number densities found here
should be multiplied by a factor between $10^{-3} - 10^{-4}$ to account for this bias.
Doing this we find a number of approximately $1 \times 10^{-5}$ cMpc$^{-3}$ as a global estimate.
