...
reaching yet the high redshifts probed in this study). Nonetheless, 
...
at least 5. Some of these haloes may ultimately be shown through higher-resolution simulations not
to support SMS formation. Nevertheless, their high mass infall rates will, at a minimum, transfer
...
formation. There are clear indications form our analysis of the radial metallicity profiles
(see Figure \ref{Fig:RadialProfiles}) that metal mixing decreases strongly towards the halo centre.
We also ran additional analysis of the SMS candidate haloes using a narrow prescrription for the
radius at which we calculate the accrateion rates and the metallicity. Using a radius of 10 pc
