...
\begin{abstract}
  The formation of super-massive stars has generally been studied under the assumptions of rapid accretion of pristine near metal-free gas. Recently it was suggested, however, that gas enriched to metallicities up to $Z \sim 10^{-3}$ \zsolar can also facilitate super-massive star formation, as long as the total mass infall rate onto the proto-star remains sufficiently high. We extend the analysis further by examining
  ...
  number of haloes hosting super-massive stars can be increased by at least a factor of 5.
...
%ZH : added 2335. OK? %JR: No because I only plot haloes with dM/dz > 1e-3
%But then 84 is more like 3.5%, so I guess either 5% or 2335 is not correct..?
the haloes
%all of the haloes 
...
%ZH: just to clarify, these are all spherically averaged (in shells with radius r) quantities, yes? Yes.
...
%JR: Debatable I guess. A few papers have definitely showed that certain hurdles exist. % I'm thinking Kohei's paper on the scaling of the number density with J21 for example. % Having said that I'm fine with the re-phrasing. I think there is still huge %  uncertainty in all estimates at the moment
