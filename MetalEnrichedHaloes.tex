...
\indent \jr{In Figure \ref{Fig:BinnedMedianInfall} we show the median infall rate for all haloes as
  ...
  rates are further broken down according to metallicity. For each halo, the median
infall rate is calculated within 20 pc of the halo centre. To plot the
median of all haloes these median values are then binned against temperature, halo mass and stellar mass
and the median in each bin again calculated. Haloes are further subdivided by their metallicity as shown.
In each case, we see that the \rarepeak region has a near
systematically higher infall rate, reflecting the more clustered environment of the \rarepeak region, where mergers
...
exceeds the atomic cooling limit (see middle panel). The high infall-rate haloes cool in their centres due to
