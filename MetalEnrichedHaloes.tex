...
\begin{abstract}
  The formation of supermassive stars has generally been studied under the assumptions of the
  ...
  affected in the case where haloes, with super-critical infall rates, with all levels of metallicity
  ...
  63\% have metallicities of $Z > 10^{-3}$ \zsolar compared to the metal-free case.
  ...
  pre-existing black holes in the halo centres. Further research into the (supermassive) star
...
the halo becomes metal enriched. There is also a noticeable decline the infal rate towards high mass haloes.
...
haloes ($84$ (2 \% of the total)) with mass infall rates greater than 1 \msolaryrc. Among these (very high-accreting)
...
we show the same histogram for the \normal region. \jr{In this case there are two metal-free halo
...
in more mature and evolved galaxies.\\
